...
add_filter('rwmb_meta_boxes', function ($mb) {
    $mb[] = [
        ...
        'fields'     => [
            ...
            ['name' => 'Galeria do studio', 'id' => 'nuvvo_contato_studio_galeria', 'type' => 'image_advanced', 'max_file_uploads' => 3, 'desc' => 'Máx. 3 imagens. Recomendado: 800×1000px. A 1ª imagem ocupa o bloco maior.'],
